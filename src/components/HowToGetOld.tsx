    ...
    switch (stepIndex) {
      case 1:
        return (
          ...
          >
            <Grid item>
              <img src={process.env.PUBLIC_URL + "/step1.png"} alt="BCC.KZ" />
            </Grid>
      ...
      case 6:
        return (
          ...
          >
            ...
            <Grid item className={classes.starBlock2}>
              <BccTypography type="h4" block className={classes.starBusiness}>
                Совершайте покупки и наслаждайтесь
              </BccTypography>
              <BccTypography type="p2" block className={classes.starSteps}>
                Насладитесь первыми шагами ребенка в финансовом мире. Позвольте
                ребенку почувствовать радость от оплаты в один клик.
              </BccTypography>
            </Grid>
          </Grid>
        );
