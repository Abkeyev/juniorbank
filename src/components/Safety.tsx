                ...
                <div className={classes.trTable}>
                  ...
                  <div className={classes.col9}>
                    ...
                    <div className={classes.trBody}>
                      ...
                      <p>2.	Ребенок, для которого была открыта карта, заполняет «Письмо Деду Морозу», где пишет, что хочет получить на Новый Год и отправляет письмо с контактными данными (ФИО и номер телефона) на почту <a href="mailto:dedmoroz@bcc.kz">dedmoroz@bcc.kz</a> с обязательной пометкой «Письмо Деду Морозу»</p>
                    ...
                    <div className={classes.trBody}>
                      <p>1. Все клиенты Банка, оформившие карту «Junior Bank» и совершившие транзакции по карте на сумму более 5 000 тенге за период действия Акции и отправившие письмо с контактными данными (ФИО и номер телефона) на почту <a href="mailto:dedmoroz@bcc.kz">dedmoroz@bcc.kz</a> с обязательной пометкой «Письмо Деду Морозу», становятся участниками Акции.</p>
